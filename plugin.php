...
wp_enqueue_script( 'leads_admin', plugins_url().sprintf('/%s/js/admin.js',PLUGIN_NAME) );
wp_enqueue_style( 'leads_admin', plugins_url().sprintf('/%s/css/admin.css',PLUGIN_NAME) );
    ...
    <div id="tabs">
        ...
        <?php
            if(isset($_GET['updated']) && $_GET['updated'] == 'true') {
                ...
                echo notification('Something went wrong');
            }
        ?>
